...
function generate() {
    ...
    let obj = {
      ...
      "secondary": {
        "name": primary,
        "a1": sarr[0] || "Cannot Add Attachment",
        "a2": sarr[1] || "Cannot Add Attachment",
        "a3": sarr[2] || "Cannot Add Attachment",
        "a4": sarr[3] || "Cannot Add Attachment",
        "a5": sarr[4] || "Cannot Add Attachment"
      },
      "perks": {
        "p1": perks[0],
        "p2": perks[1],
